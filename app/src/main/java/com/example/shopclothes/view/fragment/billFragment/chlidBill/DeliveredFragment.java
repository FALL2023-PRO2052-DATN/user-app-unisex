...
public class DeliveredFragment extends Fragment implements BillContract.View {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        assert user != null;
        mPresenter.readListBill(user.getUid(), AppConstants.DELIVERY_STATUS_DELIVERED);
    }
    ...
    public void onListBill(List<Bill> billList) {
        ...
        AdapterBill adapterBill = new AdapterBill(billList, 3,  myBottomSheetBill, null, this);
    ...
    public void onResume() {
        super.onResume();
        mPresenter.readListBill(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid(), AppConstants.DELIVERY_STATUS_DELIVERED);
    }
}